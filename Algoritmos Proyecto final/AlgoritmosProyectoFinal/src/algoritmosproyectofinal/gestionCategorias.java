...
public class gestionCategorias extends javax.swing.JFrame {
    ...
    public void obtenerDatos(){
        try {
            ...
            File listaCategorias = new File("data/listaCategorias.txt");
    ...
    public boolean validarCampos(){
        ...
        if (txtDesCat.getText().toString().compareTo("") == 0) {
            JOptionPane.showMessageDialog(null, "Advertencia: No deje vacío el campo de descripción de categoría", "Advertencia", JOptionPane.WARNING_MESSAGE);
            return false;
        }
    ...
    public boolean validarCategoria(){
        ...
        for (int i = row; i >= 0; i--) {
            if (txtDesCat.getText().compareTo(model.getValueAt(i, 0).toString()) == 0){
                isEquasAT++;
            }
        }
        ...
        if (isEquasAT > 0){
            ...
            JOptionPane.showMessageDialog(null, "No se pueden duplicar categorias de productos", "Error", JOptionPane.ERROR_MESSAGE);
    ...
    private void initComponents() {
        ...
        txtDesCat.setToolTipText("");
        txtDesCat.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDesCatActionPerformed(evt);
            }
        });

        jLabel2.setText("Descripción de la categoría:");
        ...
        categoriasTabla.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                categoriasTablaMouseClicked(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtDesCat, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnLimpiarCampos, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(btnAgregarCat, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void txtDesCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDesCatActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtDesCatActionPerformed
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        try {
            ...
            // Creación ficticia del archivo
            File listaCategoriasCopia = new File("data/listaCategoriasCopia.txt");
            BufferedWriter writer = new BufferedWriter(new FileWriter(listaCategoriasCopia, true));

            // Recopilación de datos
            while ((data = reader.readLine()) != null) {
                if (data.toString().compareTo(txtDesCat.getText()) != 0){
                    writer.write(data + "\n");
                }
            }
            ...
            Files.move(listaCategoriasCopia.toPath(), listaCategorias.toPath(), REPLACE_EXISTING);
    ...
    private void btnAgregarCatActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarCatActionPerformed
        ...
        try {
            // Creación ficticia del archivo
            File listaCategorias = new File("data/listaCategorias.txt");
            BufferedWriter writer = new BufferedWriter(new FileWriter(listaCategorias, true));

            // Escritura de datos al archivo de acceso secuencial
            writer.write(txtDesCat.getText() + "\n");
    ...
    private void categoriasTablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_categoriasTablaMouseClicked
        // Obtener la fila seleccionada de la tabla
        int row = categoriasTabla.getSelectedRow();
        
        // Obtener valores de la fila seleccionada por medio de la posición de columnas
        String desCat = categoriasTabla.getValueAt(row, 0).toString();
        
        // Reflejar los datos obtenidos en las JTextField
        txtDesCat.setText(desCat);
    }//GEN-LAST:event_categoriasTablaMouseClicked
